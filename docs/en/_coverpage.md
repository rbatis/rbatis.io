...
* Rust/Future based high-performance, fully asynchronous, compile time (dynamic SQL)
* Memory security, coroutine security, transaction security (anti-forget to commit), 100% safe code
* A variety of plug-ins, paging logic/delete/SQL interceptors/CRUD/Wrapper/PySQL/HtmlSQL
