...
`,e=e.substring(h.length+1),l=!0),!l){let S=this.rules.other.nextBulletRegex(b),C=this.rules.other.hrRegex(b),z=this.rules.other.fencesBeginRegex(b),O=this.rules.other.headingBeginRegex(b),B=this.rules.other.htmlBeginRegex(b),P=this.rules.other.blockquoteBeginRegex(b);for(;e;){let G=e.split(`
